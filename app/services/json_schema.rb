module Json_Schema
  ...
  # Dynamically generate a cards schema based on the content_type and answer_type
  def self.cards_schema(args = { content_type: "text_content", answer_type: "text_answer" })
    args => { content_type:, answer_type:}
